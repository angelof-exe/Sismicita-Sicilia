# This file filters all municipalities with classification level 1 & 2
# and calculates how many of these municipalities are present in the province
from input import dataset

# Group by Province and then count how many municipalities are classificated Level 1 and 2, then sorting them
dataset = dataset[dataset['new_classification'] <= 2].groupby(by='province').count().sort_values(by='new_classification', ascending=False)
